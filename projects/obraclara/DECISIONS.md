...
### D2. Ubicación en Mauri-dev
**Decisión:** `mauri-dev/projects/obraclara/` con specs en subcarpeta `specs/`.
**Motivo:** Sigue la regla establecida: proyectos nuevos en carpeta con nombre exacto del proyecto dentro de `Mauri-dev`.

### D3. Relación con q7-obras-01
**Decisión:** ObraClara es el sucesor productivo de q7-obras-01. q7-obras-01 queda como prototipo funcional y fuente de aprendizaje de dominio, pero no se migra código. ObraClara se construye desde cero sobre un stack y arquitectura completamente diferentes.
**Motivo:** El stack (Python/HTMX → React/Fastify) y la arquitectura (monolito → monorepo con contratos) son incompatibles. q7-obras-01 validó las necesidades del dominio; ObraClara las implementa con seriedad productiva.

### D4. Especificaciones inmutables
...
### D5. Sin implementación hasta decisión de Victor
