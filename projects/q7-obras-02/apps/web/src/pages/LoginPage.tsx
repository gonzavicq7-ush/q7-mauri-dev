    ...
    <div style={{ background: tokens.color.fondo, minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={cardStyle}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <div style={{ fontSize: '14px', color: tokens.color.textoSuave, marginTop: '4px' }}>Iniciá sesión en tu cuenta</div>
        </div>
        ...
        <div style={{ marginTop: '16px', textAlign: 'center', fontSize: '13px', color: tokens.color.textoSuave, display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <Link to="/recuperar" style={{ color: tokens.color.primario, textDecoration: 'none' }}>¿Olvidaste tu contraseña?</Link>
          <Link to="/registro" style={{ color: tokens.color.primario, textDecoration: 'none' }}>Crear cuenta nueva</Link>
        </div>
      </div>
    </div>
  );
